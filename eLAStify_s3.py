...
parser = argparse.ArgumentParser(
    description='Processes LAS data files and indexes them into an Elasticsearch cluster.')
...
def parse_las_data(las_data_doc, index_name, es):
    ...
    s3.Object(target_bucket, las_data_doc).download_file(f'/tmp/las_processing.las')
